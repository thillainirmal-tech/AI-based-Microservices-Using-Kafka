package com.fraud.transaction.filter;
 ...
 * The traceId is also stored in MDC so UpiPaymentService can read it when
 * building the TransactionEvent (for Kafka propagation).
 *
 * Behaviour:
 ...
 *   3. Store in MDC under "traceId" — referenced by logging pattern and UpiPaymentService.
